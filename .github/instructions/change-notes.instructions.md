...
Ensure that change notes follow the project's guidelines as described below the `---` delimiter. If the change note does not satisfy the aforementioned guidelines:
